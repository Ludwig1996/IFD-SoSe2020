window.addEventListener("load", function () {
    ...
    var Produktionszahlen = {
        indexes:["Wie viel wurde gestern produziert?","Wie hoch sind die Produktionszahlen?"], 
        action:function(){ 
            artyom.say("Es wurden gestern genau 74161 Stück produziert");
    ...
    var krank = {
        indexes:["Wie viele Mitarbeiter waren krank?", "wie viele Mitarbeiter sind heute krank?"], 
        action:function(){ 
            artyom.say("Gestern waren insgesamt 34 Mitarbeiter krank");
    ...
    var Ausschuss = {
        ...
        action:function(){ 
            artyom.say("Der Ausschuss lag bei 94 Stück");
    ...
    var Stück1 = {
        ...
        action:function(){ 
            artyom.say("In Werk 1 wurden gestern 18224 Stück produziert");
    ...
    var Stück2 = {
        ...
        action:function(){ 
            artyom.say("In Werk 2 wurden gestern 18454 Stück produziert");
    ...
    var Stück3 = {
        ...
        action:function(){ 
            artyom.say("In Werk 3 wurden gestern 14899 Stück produziert");
    ...
    var Stück4 = {
        ...
        action:function(){ 
            artyom.say("In Werk 4 wurden gestern 22584 Stück produziert");
